Public Class Form1
  ...
  Private Sub modulesInventory()
    ...
    If (ComboBox1.Items.Count = 0) Then
      ...
      ToolStripStatusLabel1.Text = "Connect a Yocto-Amp device"
    Else
      index = 0
      ...
      If (ComboBox1.Items.Count = 1) Then
        ToolStripStatusLabel1.Text = "One Yocto-Amp device connected"
      Else
        ToolStripStatusLabel1.Text = ComboBox1.Items.Count.ToString() + " Yocto-Amp devices connected"
      End If
  ...
  Private Sub refreshUI()
    ...
    If (ComboBox1.Enabled) Then
      REM if a yocto-amp device is connected, lets check it value
      Dim m As YModule = CType(ComboBox1.Items(ComboBox1.SelectedIndex), YModule)
      Dim DC As YCurrent = YCurrent.FindCurrent(m.get_serialNumber() + ".current1")
      Dim AC As YCurrent = YCurrent.FindCurrent(m.get_serialNumber() + ".current2")
      If (DC.isOnline()) Then
    ...
    For i = 0 To 10
      ...
      Dim dvalue As Double = ((maxvalue / 1000) * i / 10)
  ...
  Private Sub bt_10V_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bt_200mA.Click
    maxvalue = 200
  End Sub

  Private Sub bt_50V_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bt_2A.Click
    maxvalue = 2000
  End Sub

  Private Sub bt_300V_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bt_20A.Click
    maxvalue = 20000
  End Sub
End Class

'*********************************************************************
'*
'* $Id: yocto_voc.vb 25275 2016-08-24 13:42:24Z mvuilleu $
'*
...
Module yocto_voc
  ...
  Public Class YVoc
    ...
    '''   a Volatile Organic Compound sensor currently online, or a <c>Nothing</c> pointer
    ...
    ''' <returns>
    '''   a pointer to a <c>YVoc</c> object, corresponding to
    '''   the first Volatile Organic Compound sensor currently online, or a <c>Nothing</c> pointer
    '''   if there are none.
    ''' </returns>
    '''/
